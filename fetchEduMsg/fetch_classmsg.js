...
let updatemsg = function (res, dbo) {
    return new Promise((resolve, reject) => {
        // dbo.collection('edu_class1_shuxue').update({ "_id": res._id }, { $set: { artmsg: res.artmsg, artLy: res.artLy } }, function () {
        //     resolve(1)
        // })
        // dbo.collection('edu_class1_yingyu').update({ "_id": res._id }, { $set: { artmsg: res.artmsg, artLy: res.artLy } }, function () {
        //     resolve(1)
        // })
        // dbo.collection('edu_class1_yuwen').update({ "_id": res._id }, { $set: { artmsg: res.artmsg, artLy: res.artLy } }, function () {
        //     resolve(1)
        // })
        // dbo.collection('edu_class2_shuxue').update({ "_id": res._id }, { $set: { artmsg: res.artmsg, artLy: res.artLy } }, function () {
        //     resolve(1)
        // })
        // dbo.collection('edu_class2_yingyu').update({ "_id": res._id }, { $set: { artmsg: res.artmsg, artLy: res.artLy } }, function () {
        //     resolve(1)
        // })
        // dbo.collection('edu_class2_yuwen').update({ "_id": res._id }, { $set: { artmsg: res.artmsg, artLy: res.artLy } }, function () {
        //     resolve(1)
        // })
        // dbo.collection('edu_class3_shuxue').update({ "_id": res._id }, { $set: { artmsg: res.artmsg, artLy: res.artLy } }, function () {
        //     resolve(1)
        // })
        // 到这里
        // dbo.collection('edu_class3_yingyu').update({ "_id": res._id }, { $set: { artmsg: res.artmsg, artLy: res.artLy } }, function () {
        //     resolve(1)
        // })
        // dbo.collection('edu_class3_yuwen').update({ "_id": res._id }, { $set: { artmsg: res.artmsg, artLy: res.artLy } }, function () {
        //     resolve(1)
        // })
    })
}